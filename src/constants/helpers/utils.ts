...
export function create_UUID(format?: string) {
    var dt = new Date().getTime();
    let formato = format !== undefined ? format : "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx";
    var uuid = formato.replace(/[xy]/g, function (c) {
